<template>
  <div class="statistic">
    <div class="statistic__wrapper">
      ...
      <BarChartStatistic :viewportWidth="this.viewportWidth" :graphs="graphs" />
      <div class="wrap">
...
export default {
  components: { PaymentCard, BarChartStatistic, WrapTable },
  data() {
    return {
      visualType: "table",
      viewportWidth: 0,
  ...
  computed: {
    ...
    hashAvarage() {
      return Number(this.tables.workers.rows.mainRow.hashAvarage).toFixed(2);
    },
    hashAvarage24() {
      return Number(this.tables.workers.rows.mainRow.hashAvarage24).toFixed(2);
    },
    rejectRate() {
      return Number(this.tables.workers.rows.mainRow.rejectRate).toFixed(2);
    },
    active() {
      let val = 0;
