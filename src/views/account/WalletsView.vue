    ...
    <div class="wallets__container">
        ...
        <div class="wallets__row wallets__row-balance">
          <div class="wallets__column">
            ...
            <span class="wallets__value">
              <span>{{ Number(this.fullCash).toFixed(8) }}</span> BTC</span
            >
          </div>
        ...
        <div class="wallets__row">
          <div class="wallets__block">
            <div class="wallets__column">
              ...
              <span class="wallets__value"
                ><span>{{ Number(this.walletsCash).toFixed(8) }}</span>
                BTC</span
              >
            </div>
          </div>
          <div class="wallets__block">
            <div class="wallets__column">
              ...
              <span class="wallets__value"
                ><span>{{ Number(this.miningCash).toFixed(2) }}</span> %</span
              >
            </div>
          </div>
          <div class="wallets__block">
            <div class="wallets__column">
              ...
              <span class="wallets__value">
                <span>{{ Number(this.waitingCash).toFixed(2) }}</span> %</span
              >
            </div>
          </div>
        </div>
      ...
      <div ref="wallets" class="wallets__wrap">
        <h3 class="wallets__title">
          Список кошельков
          <main-checkbox class="wallets__filter" @is_checked="this.checkboxer">
        ...
        <div ref="list" class="wallets__list" v-if="!this.isChecked">
          ...
          >
            <div class="wallets__block_name">
              <img :src="`/static/assets/img/${wallet.img}`" />
