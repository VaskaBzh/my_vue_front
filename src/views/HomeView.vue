    ...
    <div class="home__container">
      <div class="home__main">
        <div class="home__content">
          <main-title tag="h1" class="home__title" v-scroll="'left delay--md'">
              ...
              <ul class="home-im__content_list">
                <li class="home-im__content_item">
                  ...
                  <div class="item_info bgb">
                    <span v-value-scroll>{{
                      this.BTCDifficulty.toLocaleString("en-EN")
                    }}</span
                    ><span>+32.05 T</span>
                  </div>
                </li>
...
.home {
  ...
  &__background {
    ...
    &_5 {
      ...
      right: -34.9em;
      will-change: transform;
      animation: keyshow5 1.7s ease forwards, imag5 12s 1.7s infinite linear;
    }
