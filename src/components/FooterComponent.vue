      ...
      <div class="footer__row">
        <div class="footer__social_con">
          ...
          <div class="footer__social socials">
            <a href="#" class="footer__social_link socials_link teleg">
              <svg
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <stop offset="0.9999" stop-color="#3F66B6" />
                  </linearGradient>
                </defs>
              </svg>
            </a>
            ...
            <a href="#" class="footer__social_link socials_link inst">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <a href="#" class="footer__social_link socials_link youtube">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="16"
        ...
        <ul class="footer__contacts contacts">
          ...
          <li class="footer__contacts_item contacts_item">
            ...
            <span
              >ВDubai Silicon Oasis, DDP, Building A2, Dubai, United Arab
              Emirates</span
            >
          </li>
        </ul>
