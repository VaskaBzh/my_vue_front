<template>
  <div class="table-block" v-if="this.visualType === 'block'">
    ...
    <div class="table-block_block" v-for="(row, i) in this.table.rows" :key="i">
      <div class="table-block_column">
        <span
          class="main__name table-block_title"
          v-for="(title, index) in this.table.shortTitles"
  ...
  <table class="table" v-else>
    <thead>
      <tr v-if="this.viewportWidth > 991.98">
        <th class="main__name" v-for="(title, i) in this.table.titles" :key="i">
          {{ title }}
        </th>
      </tr>
      <tr v-else>
    ...
    <tbody>
      <tr v-if="this.viewportWidth > 991.98" class="row-main" :key="mainRow">
      ...
      <tr
        v-else-if="this.viewportWidth < 991.98 && this.viewportWidth > 767.98"
        class="row-main"
        :key="mainRow"
      >
        <td class="main__number">{{ this.mainRow.hash }}</td>
