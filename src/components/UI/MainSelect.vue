  ...
  <div ref="select" class="select_con" :class="{ open: select_is_open }">
    ...
    <div class="select_options">
      ...
      >
        ...
        <p v-else class="main_select" @click="selectOptions(option.title)">
          {{ option.title }}
        </p>
      </div>
    </div>
...
export default {
  ...
  computed: {
    optionsImgs() {
      ...
      for (let i = 0; i < this.options.length; i++) {
        obj.push(`/static/assets/img/${this.options[i].img}`);
      }
      return obj;
    },
  },
  methods: {
    selectOptions(optionTitle, optionImg) {
      ...
      this.baseImg = `/static/assets/img/${optionImg}`;
    },
    hideSelect() {
    ...
    openSelect() {
      ...
      this.$refs.select.querySelector(".select_options").style.zIndex = 10;
    ...
    locker(bool) {
      if (bool === true) {
        this.$refs.select.classList.add("lock-select");
      } else {
        this.$refs.select.classList.remove("lock-select");
      }
    },
  },
  mounted() {
    this.$refs.select.querySelectorAll(".select_option").forEach((option) => {
    ...
    if (this.options[0].img) {
      this.baseImg = `/static/assets/img/${this.options[0].img}`;
    }
    this.handleScroll();
      ...
      & .select {
        ...
        &_options {
          ...
          @media (max-width: 479.98px) {
            ...
            max-height: calc($adaptHeight * 5 + $adaptHeight / 3 + 10px);
          }
          &-reverse {
      ...
      &.open {
        .select {
          &_options {
            ...
            max-height: calc($miniHeight * 5 + $miniHeight / 3 + 10px);
            @media (max-width: 479.98px) {
              padding-top: calc($adaptMiniHeight / 3);
              margin-top: calc($adaptMiniHeight / -4);
              max-height: calc(
                $adaptMiniHeight * 5 + $adaptMiniHeight / 3 + 10px
              );
            }
            &-reverse {
              padding-top: 0 !important;
              ...
              @media (max-width: 479.98px) {
                ...
                padding-top: 0 !important;
                margin-top: 0 !important;
                padding-bottom: calc($adaptMiniHeight / 3) !important;
                margin-bottom: calc($adaptMiniHeight / -4) !important;
              }
            }
          }
        }
      ...
      &.open {
        .select {
          &_options {
            ...
            max-height: calc($largeHeight * 5 + $largeHeight / 3 + 10px);
            @media (max-width: 479.98px) {
              padding-top: calc($adaptLargeHeight / 3);
              margin-top: calc($adaptLargeHeight / -4);
              max-height: calc(
                $adaptLargeHeight * 5 + $adaptLargeHeight / 3 + 10px
              );
            }
            &-reverse {
              padding-top: 0 !important;
              ...
              @media (max-width: 479.98px) {
                ...
                padding-top: 0 !important;
                margin-top: 0 !important;
                padding-bottom: calc($adaptLargeHeight / 3) !important;
                margin-bottom: calc($adaptLargeHeight / -4) !important;
              }
            }
          }
        }
